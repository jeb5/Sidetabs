...
import { ReactComponent as SIDETABS_ICON } from "../../assets/app_icons/sidetabs.svg";
  ...
  return optionsLoaded ? (
    <>
      ...
      <div className="options-side-pane">
        ...
        <LinkButton
          href={browser.runtime.getURL("../welcome/welcome.html")}
