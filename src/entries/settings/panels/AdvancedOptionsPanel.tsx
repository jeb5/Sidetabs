...
export default function AdvancedOptionsPanel({
  ...
  const [userchromeExplanationDialogOpen, setUserchromeExplanationDialogOpen] =
  ...
  return (
    <section>
      ...
      <Dialog
        ...
        dismissCallback={() => warningCancelCallback()}
      >
        <div className="warning-dialog-content">
          <div className="warning-dialog-inner-content">
            <div className="warning-dialog-heading">
              These settings will only affect Sidetabs once you manually update
              your UserChrome.css file with the generated CSS
            </div>
            <WarningLabel className="warning-dialog-warning-label">
              This is advanced configuration. Please only proceed if you
              understand how to safely modify your UserChrome.css file.
            </WarningLabel>
          </div>
          <div className="bottom-buttons">
            <LinkButton onClick={() => warningCancelCallback()}>
              Cancel
            </LinkButton>
            <LinkButton onClick={() => setWarningDialogOpen(false)}>
              Continue
            </LinkButton>
          </div>
        </div>
      ...
      <div className="section-header">
        ...
        <LinkButton
          onClick={() => setUserchromeExplanationDialogOpen(true)}
