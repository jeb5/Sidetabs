  ...
  return (
    <Controller
      ...
      render={({
        ...
        <div
          className="multi-order-option option-field"
            ...
            {Object.keys(props.availableOptionLabels)
              ...
              .map((optionName) => (
                ...
                >
                  ...
                  <div className="multi-order-item-label">
                    {props.availableOptionLabels[optionName]}
                  </div>
                </div>
              ))}
          </div>
