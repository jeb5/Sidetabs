  ...
  return (
    <section>
      ...
      <Subsection title="Themes" icon={<THEMES_ICON />}>
          ...
          options={[
            {
              value: "custom",
              label:
                "Automatically generate theme colors from active browser theme",
            },
        ...
        <CheckBoxOption
          formRegister={registerForm("theme/showAdditionalImages")}
        >
      ...
      <Subsection title="Context Menu" icon={<TOOLBAR_ICON />}>
        ...
        <CheckBoxOption
          formRegister={registerForm("ctxMenu/showSidetabsOptions")}
        >
        ...
        <br />
        <p>
          Select items from the availiable list and click the arrow to add them
          to your menu items. Drag the menu items to rearrange them.
        </p>
      </Subsection>
    </section>
  );
