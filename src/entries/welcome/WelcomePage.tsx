      ...
      <div className="welcome-container">
        <div className="main-scroll-box">
          <header>
            ...
            {/* <a className="linkButtonDupe" href={settingsPage}>
              <PREFERENCES_ICON />
              <span>Sidetabs Preferences</span>
            </a> */}
          </header>
          <main>
            <section>
            ...
            <section className="customising-section">
              ...
              <div>
                <div>
                  <p>
                    If you want to completely switch to using vertical tabs,
                    you'll probably want to hide the un-closable “Sidetabs”
                    header at the top of the sidebar, and hide the horizontal
                    tabs.
                  </p>
                  <p>
                    You can achieve this by modifying your browser's{" "}
                    <strong>UserChome.css</strong> file. Instructions for doing
            ...
            <section>
              ...
              <p>
                ...
                <a href="https://github.com/jeb5/SideTabs/issues">
                  open an issue on Github
                </a>
                . I may not have time to implement many new features, so Pull
                Requests would also be welcome.
              </p>
            </section>
          </main>
        </div>
